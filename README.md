...
I combine analytical thinking from my psychology background with technical skills in Python and Django. I care deeply about how products feel to users – not just whether they work.
...
| [Sea Battle](https://github.com/Kotelaa/Sea-Battle) | Classic Battleship game in Python. | Python |
| [Tic Tac Toe](https://github.com/Kotelaa/Tic_tac_toe) | Tic Tac Toe game with player vs player logic. | Python |
